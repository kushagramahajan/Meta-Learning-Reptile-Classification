...
def argument_parser():
    ...
    parser.add_argument('--meta-iters', help='meta-training iterations', default=400, type=int)
    ...
    parser.add_argument('--eval-samples', help='evaluation samples', default=10, type=int)
